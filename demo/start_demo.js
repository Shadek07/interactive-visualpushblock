...
if (camera_mode) {
  ...
  the_car_data_dir = 'demo/pushblockdata/'; //visual pushblock data show: demo/pushblockdata/
}
//
var interesting_doom = [0, 2, 4, 7, 9, 13, 15, 22, 24, 25, 27, 33, 52, 55, 59];
var interesting_car = [2, 5, 6 , 12, 17, 18, 22, 28, 35, 44, 49, 51, 5, 59, 60]; //try these too: 7, 15, 24, 40 ,41, 55
/*
